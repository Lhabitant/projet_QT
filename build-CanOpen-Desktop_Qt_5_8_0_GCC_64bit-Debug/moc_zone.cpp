...
void Zone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Zone *_t = static_cast<Zone *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchC(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Zone::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Zone.data,
      qt_meta_data_Zone,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Zone::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Zone.stringdata0))
        return static_cast<void*>(const_cast< Zone*>(this));
